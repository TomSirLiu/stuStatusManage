    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="button" class="btn btn-info" onclick="selectStu()">查询学生信息</button>
                <button type="button" class="btn btn-primary" onclick="alterStatus()">修改学籍状态</button>
            </div>
        </div>
    </form>
</div>
...
<script src="${pageContext.request.contextPath}/assets/js/myJS/alterStuStatus.js"></script>
